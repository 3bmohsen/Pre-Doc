...
@section('content')
<h1 class="text-center cairo-bold pt-5">إضافة مستخدم</h1>

<form class="p-5 d-flex flex-column justify-content-end align-items-center" dir="rtl" action="/user/insert" method="POST">
@if(session('success'))
...
<button class="btn btn-primary m-3" style="width: 160px;" type="submit">إضافة المستخدم</button>
