...
@section('content')
<div class="container">
    <h1 class="p-5 text-center cairo-bold">قائمة المستخدمين</h1>
    <hr>
    <div class="p-3  text-success text-center"><h5 class="cairo-bold">اجمالي عدد المستخدمين: {{$count}}</h5></div>
    <hr>
    @if(session('success'))
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body text-center">
                    {{$user->name}} هل انت متأكد من حذف المستخدم
                  </div>
