...
@section('title','إضافة المشرف')
@section('content')
<h1 class="text-center cairo-bold pt-5">إضافة المشرف</h1>

<form class="p-5 d-flex flex-column justify-content-end align-items-center" dir="rtl" action="/admin/insert" method="POST">
@if(session('success'))
...
<button class="btn btn-primary m-3" style="width: 160px;" type="submit">إضافة المشرف</button>
