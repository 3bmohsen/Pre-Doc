...
@section('content')
<div class="container">
    <h1 class="p-5 text-center cairo-bold">قائمة المشرفين</h1>
    <hr>
    <div class="p-3  text-success text-center"><h5 class="cairo-bold">اجمالي عدد المشرفين: {{$count}}</h5></div>
    <hr>
    @if(session('success'))
...
<table class=" table text-center" style="direction: rtl;">
  <thead>
    <tr>
      ...
      <th scope="col">حذف المشرف</th>
      <th scope="col">تعديل المشرف</th>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          {{$user->name}} هل انت متأكد من حذف المشرف
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">إغلاق</button>
          <a href="/del/user/{{$user->id}}"><button type="button" class="btn btn-danger">حذف المشرف</button></a>
        </div>
      </div>
    </div>
  </div>
