...
@section('content')
<h1 class="text-center cairo-bold pt-5">تعديل مستخدم</h1>

<form class="p-5 d-flex flex-column justify-content-end align-items-center" dir="rtl" action="/updateuser/{{$user->id}}" method="POST">
@if(session('success'))
