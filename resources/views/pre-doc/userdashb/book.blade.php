...
<form class="p-5 d-flex flex-column justify-content-end align-items-center" action="/user/book/add" method="POST">
    ...
    <div class="d-flex flex-md-row flex-column align-items-center justify-content-center ">
        <div class="form-floating m-3">
            <input type="date" class="form-control" style="border: 2px solid black;" id="book_date" name="book_date" placeholder="">
            <label for="book_date" class="text-center cairo-bold">ميعاد الجلسة</label>
        </div>
        <div class="form-floating m-3">
            <input type="text" class="form-control text-center" style="border: 2px solid black;" id="book_addr" name="book_addr" placeholder="">
            <label for="book_addr" class="text-center cairo-bold">عنوانك بالتفصيل</label>
        </div>
    </div>
    <div class="d-flex flex-column">
    <div class="form-floating ">
            <input type="number" class="form-control text-center" style="border: 2px solid black;" id="book_price" name="book_price" placeholder="">
            <label for="book_price" class="text-center cairo-bold">السعر المقترح للجلسة</label>
        </div>

    
</div>
<button class="btn btn-primary m-3" style="width: 160px;" type="submit">إرسال الحجز</button>
